...
# Source plugins
. "$ZDOTDIR/zsh-env.zsh"
. "$ZDOTDIR/zsh-osc7.zsh"
. "$ZDOTDIR/zsh-theme.zsh"
. "$ZDOTDIR/zsh-title.zsh"
. "$ZDOTDIR/zsh-prompt.zsh"
. "$ZDOTDIR/zsh-aliases.zsh"
. "$ZDOTDIR/zsh-key-bindings.zsh"
. "$ZDOTDIR/zsh-shift-select.zsh"
. "$ZDOTDIR/zsh-autosuggestions.zsh"
. "$ZDOTDIR/zsh-clipboard.zsh" 
